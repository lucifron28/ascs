...
export const DEMO_APPLICATION_FIXTURES: DemoApplicationFixture[] = [
  ...
  // Student E: Pending at Stage 1 (Librarian). Demonstrates active Librarian pending queue.
  {
    id: 'app-student-e',
    applicationNumber: 'CLR-2026-000005',
    studentUid: 'demo-student-e-uid',
    studentNumber: 'STUD-2026-0005',
    studentName: 'Student E (Temp Pass)',
    program: studentProgram('student-e'),
    yearLevel: '1st Year',
    section: 'A',
    academicYear: '2026-2027',
    ...
    notApprovedCount: 0,
    approvals: {
      librarian: { status: 'pending', remarksLatest: null },
      osa_coordinator: { status: 'pending', remarksLatest: null },
      guidance_counselor: { status: 'pending', remarksLatest: null },
      area_chair: { status: 'pending', remarksLatest: null },
      dean: { status: 'pending', remarksLatest: null },
