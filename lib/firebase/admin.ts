...
const adminAuth: Auth = adminApp ? getAuth(adminApp) : (null as unknown as Auth);
const adminDb: Firestore = adminApp ? getFirestore(adminApp) : (null as unknown as Firestore);
