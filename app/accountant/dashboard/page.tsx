    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="card w-full max-w-md bg-slate-900 border border-slate-800 shadow-2xl p-8 rounded-2xl text-center animate-fade-in">
          ...
          <h1 className="text-2xl font-bold capitalize mb-2">accountant Dashboard</h1>
          ...
          <div className="badge badge-indigo border-indigo-500/30 bg-indigo-950/50 text-indigo-300 p-3 rounded-md font-medium text-xs">Role: accountant</div>
        </div>
      </div>
    </div>
  );
